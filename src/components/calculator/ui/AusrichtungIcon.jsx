...
export default function AusrichtungIcon({ label, active, size = 36 }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 48 48" role="img" aria-label={`Ausrichtung ${label}`}>
      <circle cx="24" cy="24" r="19" fill="none" stroke={c} strokeWidth="1.6" opacity={active ? 0.6 : 0.35} />
      <path d="M24 2.5v3.5M24 42v3.5M2.5 24H6M42 24h3.5" stroke={c} strokeWidth="1.6" strokeLinecap="round" opacity="0.45" />
